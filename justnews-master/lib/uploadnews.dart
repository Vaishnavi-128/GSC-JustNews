...
class _NewsPostScreenState extends State<NewsPostScreen> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
              "Your article has been submitted for review. Thank you for contributing!"),
          actions: [
            TextButton(
              onPressed: () {
  ...
  void addPost() async {
    ...
    String n = "/" + userid;
    firebase_storage.Reference store_ref =
        firebase_storage.FirebaseStorage.instance.ref(n + id);

    firebase_storage.UploadTask uploadTask =
        store_ref.putFile(_image!.absolute);
